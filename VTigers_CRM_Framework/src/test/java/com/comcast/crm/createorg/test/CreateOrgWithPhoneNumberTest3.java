...
public class CreateOrgWithPhoneNumberTest3 {
	public static void main(String[] args) throws Throwable {
		...
		// mouse hover administrator and click on sign out
		Thread.sleep(1000);
		WebElement signOut = driver
				.findElement(By.xpath("//td[@class='small']/img[@src='themes/softed/images/user.PNG']"));
		Actions action = new Actions(driver);
		action.moveToElement(signOut).perform();
		Thread.sleep(1000);
		driver.findElement(By.id("_my_preferences_")).click();
